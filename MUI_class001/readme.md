...
1. Change Navbar CTA button text
2. Add an icon to it (`startIcon`, from `@mui/icons-material`)
3. Change Hero heading
4. Change Hero background color
5. Change image `borderRadius`
6. Change spacing values, see what shifts
7. Check mobile view
8. Change Navbar button colors + hover
9. Add hover to a Hero button
